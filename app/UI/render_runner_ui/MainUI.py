...
class UI:
    ...
    def start(self):
        while True:
            ...
            choice = validations.input_int(
                prompt='Type the number of the option',
                gt=0,
                le=len(main_options))

            method_name = main_options[choice][1]
...
# -----------------------------------menu functions---------------------------
    ...
    def create_job(self):
        ...
        template = base_path / str(template_name)
        # print(template)
    ...
    def view_jobs(self):
        '''
        view top 3 queued jobs and top 2 running jobs
        '''
